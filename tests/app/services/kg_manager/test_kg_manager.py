...
def test_import_kg(requests_mock, mocker, capsys):
    mocker.patch(
    ...
    requests_mock.post('http://bff_cli' + '/v1/kg/resources', 
        json={
            "code":200,
            "error_msg":"",
            "result":{
                "processing":{
                    "sample_file.json":{
                        ...
                        "_deprecated":False,
                        "_incoming":"http://10.3.7.220/kg/v1/resources/dataset/_/d09d9594-e495-425b-a6a6-68e230ee139e/incoming",
                        "_outgoing":"http://10.3.7.220/kg/v1/resources/dataset/_/d09d9594-e495-425b-a6a6-68e230ee139e/outgoing",
...
def test_import_kg_folder(requests_mock, mocker, capsys):
    mocker.patch(
        'app.services.user_authentication.token_manager.SrvTokenManager.check_valid',
        return_value = 0
    )
            ...
            "result":{
                "processing":{
                    "json_test/fake_file1.json":{
                        ...
                        "_createdBy":"http://10.3.7.220/kg/v1/realms/users/test_user",
                        "_deprecated":False,
                        "_incoming":"http://10.3.7.220/kg/v1/resources/dataset/_/6b3d6b08-921a-4e73-9f53-93bdb77d76e1/incoming",
                        "_outgoing":"http://10.3.7.220/kg/v1/resources/dataset/_/6b3d6b08-921a-4e73-9f53-93bdb77d76e1/outgoing",
                        "_project":"http://10.3.7.220/kg/v1/projects/dataset",
                        "_rev":1,
                        "_schemaProject":"http://10.3.7.220/kg/v1/projects/dataset",
                    ...
                    "json_test/fake_file2.json":{
                        ...
                        "_createdBy":"http://10.3.7.220/kg/v1/realms/users/test_user",
                        "_deprecated":False,
                        "_incoming":"http://10.3.7.220/kg/v1/resources/dataset/_/b3088a27-4a44-4bf0-a952-942f9bf8a4f4/incoming",
                        "_outgoing":"http://10.3.7.220/kg/v1/resources/dataset/_/b3088a27-4a44-4bf0-a952-942f9bf8a4f4/outgoing",
                        "_project":"http://10.3.7.220/kg/v1/projects/dataset",
                        "_rev":1,
                        "_schemaProject":"http://10.3.7.220/kg/v1/projects/dataset",
                    ...
                    "json_test/fake_file3.json":{
                        ...
                        "_createdBy":"http://10.3.7.220/kg/v1/realms/users/test_user",
                        "_deprecated":False,
                        "_incoming":"http://10.3.7.220/kg/v1/resources/dataset/_/c45b0998-65e0-4436-a6fe-0a5b4fb1c854/incoming",
                        "_outgoing":"http://10.3.7.220/kg/v1/resources/dataset/_/c45b0998-65e0-4436-a6fe-0a5b4fb1c854/outgoing",
                        "_project":"http://10.3.7.220/kg/v1/projects/dataset",
                        "_rev":1,
                        "_schemaProject":"http://10.3.7.220/kg/v1/projects/dataset",
