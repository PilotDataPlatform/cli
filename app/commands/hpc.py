...
@click.option('-h', '--host', prompt='Host', help=(hpc_help.hpc_help_page(hpc_help.HpcHELP.HPC_LOGIN_HOST)))
@click.option('-U', '--username', prompt='Username', help=(hpc_help.hpc_help_page(hpc_help.HpcHELP.HPC_LOGIN_USERNAME)))
@click.option(
    '-P',
    '--password',
    prompt='Password',
...
@click.option('-h', '--host', prompt='Host', help=(hpc_help.hpc_help_page(hpc_help.HpcHELP.HPC_LOGIN_HOST)))
@click.argument('job_id', type=click.STRING, nargs=1)
...
@click.option('-h', '--host', prompt='Host', help=(hpc_help.hpc_help_page(hpc_help.HpcHELP.HPC_LOGIN_HOST)))
@click.argument('node_name', type=click.STRING, nargs=1)
...
@click.option('-h', '--host', prompt='Host', help=(hpc_help.hpc_help_page(hpc_help.HpcHELP.HPC_LOGIN_HOST)))
@click.argument('partition_name', type=click.STRING, nargs=1)
